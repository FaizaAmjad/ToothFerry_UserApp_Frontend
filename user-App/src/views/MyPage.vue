        ...
        <div class="my-page d-flex align-items-center justify-content-center">
            <div class="col-7 main-mypage">
                <form class="col-lg-6">
                    ...
                    <input type="text" :placeholder="showOtherField ? '' : email" v-model="newEmail"
                        :disabled="!showOtherField" />
                    <input v-if="showOtherField" type="text" v-model="postalCode" placeholder="New Postal Code" />
                    <input v-if="showOtherField" type="password" v-model="password" placeholder="New Password" />
                    ...
                    <div class="theme mt-3 d-flex flex-column align-items-center">
                        <div>
                            Current Language:
                            <b-dropdown id="dropdown-right" right
                                :text="selectedLanguage.charAt(0).toUpperCase() + selectedLanguage.slice(1)" variant="primary"
                                class="ml-2">
                                <b-dropdown-item @click="setSelectedLanguage('english')" href="#">English</b-dropdown-item>
                                <b-dropdown-item @click="setSelectedLanguage('swedish')" href="#">Swedish</b-dropdown-item>
                                <b-dropdown-item @click="setSelectedLanguage('korean')" href="#">Korean</b-dropdown-item>
                            </b-dropdown>
                        </div>
